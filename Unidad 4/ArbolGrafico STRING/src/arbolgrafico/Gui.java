...
public class Gui extends javax.swing.JFrame {
    ...
    private void botonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertarActionPerformed
        try {
            String dato = (JOptionPane.showInputDialog("Escriba un nombre para insertar:"));
            if (this.simulador.insertar(dato)) {
                JOptionPane.showMessageDialog(null, "El nombre fue insertado correctamente", "AGREGADO", 1);
                this.inicializar(true);
                
                complementos();
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "No se pudo agregar el nombre", "Intenta de nuevo...", 0);
    ...
    private void cmdBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdBuscarActionPerformed
        String dato_a_buscar = (JOptionPane.showInputDialog("Por favor escriba un nombre a buscar en el arbol:"));
    ...
    private void cmdBuscarPadreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdBuscarPadreActionPerformed
        String dato_a_buscar = (JOptionPane.showInputDialog("Por favor escriba un nombre para buscarle su Padre: "));
    ...
    private void botonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBorrarActionPerformed
        try {
            String dato = (JOptionPane.showInputDialog("Digite persona a borrar: "));
    ...
    private void repintarArbol() {
        ...
        this.jInternalFrame2 = new JInternalFrame("ARBOL DE ALUMNOS DEL ITT (ABB)", true);
