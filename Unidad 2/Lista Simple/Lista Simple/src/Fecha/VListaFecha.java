 ...
 * @author Usuario
 */
public class VListaFecha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtEliminarFecha.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtEliminarFechaKeyTyped(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtEliminarFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void llenarTblV3(){
        ...
        for(int i=0;i<List.lengthList();i++){
            try {
                ...
                Logger.getLogger(VListaFecha.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       limpiarTbl();
        List.eliminar(txtEliminarFecha.getText());
            lblMayor.setText("Mayor: "+List.mayor());
            lblMenor.setText("Menor: "+List.menor());
        txtEliminarFecha.setText("");
       llenarTblV3();
    ...
    private void txtEliminarFechaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEliminarFechaKeyTyped
       char tecla=evt.getKeyChar();
       if(tecla==KeyEvent.VK_ENTER){
         btnEliminar.doClick();
       }
    }//GEN-LAST:event_txtEliminarFechaKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VListaFecha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VListaFecha().setVisible(true);
            }
        });
    }
    private DefaultTableModel modelo;
    public ListaSimpleFecha List;
